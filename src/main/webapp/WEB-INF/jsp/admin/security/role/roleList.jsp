		        ...
		        <div class="col-xs-12">
		          <div class="box">
		            ...
		            <div class="box-header">
		              <div style="float:left;margin-right:10px"><a class="btn btn-success" href="admin/security/role/add/init">新增</a></div>
		              <form class="form-inline" name="searchForm" id="searchForm" style="margin-bottom: 15px;">
							...
							<div class="form-group">
								<input type="text" class="form-control" id="keyword" name="keyword" placeholder="角色名、真实姓名" value="${keyword }"/>
							</div>
		            ...
		            <c:if test="${pageInfo.items != null && pageInfo.items.size() > 0 }">
		              <table id="example2" class="table table-bordered table-hover">
		                ...
		                <c:forEach items="${pageInfo.items}" var="u" varStatus="s">
     					<tr>
							...
							<td>
								<c:if test="${u.auIsValid == 1 }">
									<a class="btn btn-success" href="admin/security/role/edit/init?id=${u.auId }">
										修改
									</a>
									<a class="btn btn-danger" href="admin/security/role/reset?id=${u.auId }" >注销</a>
								</c:if>
								<c:if test="${u.auIsValid == 0 }">
									<a class="btn btn-success" href="admin/security/role/reset?id=${u.auId }" >恢复</a>
								</c:if>
							</td>
						</tr>
						</c:forEach>
					  ...
					  <jsp:include page="../../include/pojoPageInfo.jsp" >
							<jsp:param value="admin/security/role/list" name="act"/>
	...
	<script type="text/javascript">
		$(document).ready(function(){	
			...
			$("#searchBtn").bind("click", function(){
				...
				form.action = "admin/security/role/list";
				$("#page").val(1);
				form.submit();
			});
