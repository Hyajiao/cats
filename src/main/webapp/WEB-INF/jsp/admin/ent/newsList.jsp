...
<div>
    ...
    <div class="comm clear">
        <jsp:include page="../include/entSidebar.jsp">
            <jsp:param value="nav_news" name="navId"></jsp:param>
        </jsp:include>
...
<script>
    ...
    function halfMonth(){
        ...
        getNewsAnalyze(startDate,endDate);
        //选中状态
        $("#hm").addClass("select");
    ...
    //资讯检索接口
    function getNewsList(startDate,endDate){
        $("#allDataList").empty();
                ...
                if (json.success) {
                    ...
                    if(count >0){
                        ...
                        for (var i = 0; i < count; i++) {
                            ...
                            html = html+ '<li>'+
                                '<div class="lf">'+
                                '<img src="static/ent/images/zixun.png" style="width:128px;height:54px;"/>'+
                                '<b class="'+timeClass+'">'+time+'</b>'+
                                '</div>'+
                                '<div class="rt right_message">'+
                                '<h1><a href="'+list[i].content_url+'" target="_blank" style="color:#373737;">'+list[i].title+'</a></h1>'+
                                '<p>'+list[i].digest+'</p>'+
                                '</div>'+
                                '</li>';
                        }
    ...
    //资讯统计接口
    function getNewsAnalyze(startDate,endDate){
        $("#nodata").show();
        $("#main").hide();
