...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>新增专家组</h1>
            <ol class="breadcrumb">
                <li><a href="admin/expert/group/list"><i class="fa fa-dashboard"></i>专家组列表</a></li>
                <li class="active">新增专家组</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <form class="form-horizontal" role="form" id="groupForm" name="groupForm"
                              action="admin/expert/group/add" method="post">
